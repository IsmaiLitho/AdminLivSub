...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'pc_sbb' => [
            'driver' => env('PCSBB_DB_DRIVER'),
            'host' => env('PCSBB_DB_HOST'),
            'port' => env('PCSBB_DB_PORT'),
            'database' => env('PCSBB_DB_DATABASE'),
            'username' => env('PCSBB_DB_USERNAME'),
            'password' => env('PCSBB_DB_PASSWORD'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
        ...
        'pc_sbb_qa' => [
            'driver' => env('PCSBBQA_DB_DRIVER'),
            'host' => env('PCSBBQA_DB_HOST'),
            'port' => env('PCSBBQA_DB_PORT'),
            'database' => env('PCSBBQA_DB_DATABASE'),
            'username' => env('PCSBBQA_DB_USERNAME'),
            'password' => env('PCSBBQA_DB_PASSWORD'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
